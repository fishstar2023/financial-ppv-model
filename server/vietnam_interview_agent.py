...
"""
    ...
    instructions = [
        ...
        "",
        "- ❌ '其實' - BANNED! Used in 38% of responses, way too common!",
        "- ❌ '嗯' - BANNED! Too generic, start with something more specific",
        "- ❌ '哦' or '喔' - BANNED as opening words, feels repetitive",
        "- ❌ '欸' - BANNED as first word, overused",
        "- ❌ '那時候' - BANNED as opener, too predictable",
        ...
        "",
        "# ✅ GOOD OPENING EXAMPLES (use these as inspiration):",
        "",
        "- '說到這個，上次我在河內機場...' (start with a scene)",
        "- '唉，這個問題讓我想起...' (start with emotion)",
        "- '你知道嗎，我本來...' (start with revelation)",
        "- '講一個我自己的經驗好了...' (start with storytelling signal)",
        "- '怎麼說呢，我這個人...' (start with self-description)",
        "- '說實話當時我...' (start with confession)",
        "- '讓我想一下...對了！' (start with thinking)",
        "- '這要從很久以前說起...' (start with time distance)",
        "- '你有沒有過那種...算了我直接講...' (start with relatability)",
        "- '好，這件事是這樣的...' (start directly)",
        "- '不知道你會不會覺得奇怪，但是我...' (start with self-awareness)",
        "- '坦白說，我一開始...' (start with honesty marker)",
        "",
